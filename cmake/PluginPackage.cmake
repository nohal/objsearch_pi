...
IF(APPLE)
 ...
 #  This avoids absolute paths in the objsearch.pkgproj file

configure_file(${PROJECT_SOURCE_DIR}/cmake/gpl.txt
            ${CMAKE_CURRENT_BINARY_DIR}/license.txt COPYONLY)

configure_file(${PROJECT_SOURCE_DIR}/buildosx/InstallOSX/pkg_background.png
            ${CMAKE_CURRENT_BINARY_DIR}/pkg_background.png COPYONLY)

 # Patch the pkgproj.in file to make the output package name conform to ObjSearch-Plugin_x.x.pkg format
 #  Key is:
 #  <key>NAME</key>
 #  <string>ObjSearch-Plugin_${VERSION_MAJOR}.${VERSION_MINOR}</string>

 configure_file(${PROJECT_SOURCE_DIR}/buildosx/InstallOSX/objsearch.pkgproj.in
            ${CMAKE_CURRENT_BINARY_DIR}/objsearch.pkgproj)

 ADD_CUSTOM_COMMAND(
   OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/ObjSearch-Plugin.pkg
   COMMAND /usr/local/bin/packagesbuild -F ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_BINARY_DIR}/objsearch.pkgproj
   WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}
   DEPENDS objsearch_pi
   COMMENT "create-pkg [${PACKAGE_NAME}]: Generating pkg file."
)

 ADD_CUSTOM_TARGET(create-pkg COMMENT "create-pkg: Done."
 DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/ObjSearch-Plugin.pkg )
